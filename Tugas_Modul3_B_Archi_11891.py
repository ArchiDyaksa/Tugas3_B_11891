...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1891</h1>", unsafe_allow_html=True)
st.markdown("""<p style='text-align: center; color: #0073e6;'>Aplikasi ini berguna untuk memprediksi IPK berdasarkan nulai Matematika, Bahasa Inggris, dan Bahasa Indonesia</p>""", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\ASUS\Downloads\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_B_11891'
